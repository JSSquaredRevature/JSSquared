 ...
 * 2018-10-02T12:01:08.110-04:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "messageGenService", 
                  wsdlLocation = "http://10.252.0.247:8080/SOAPGreeting/greetingservice?wsdl",
...
public class MessageGenService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.252.0.247:8080/SOAPGreeting/greetingservice?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MessageGenService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://10.252.0.247:8080/SOAPGreeting/greetingservice?wsdl");
        }
        WSDL_LOCATION = url;
    }
